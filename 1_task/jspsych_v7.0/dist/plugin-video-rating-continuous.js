var jsPsychVideoRatingContinuous = (function (jsPsych) {
  ...
  class VideoRatingContinuousPlugin {
    ...
    trial(display_element, trial) {
      ...
      console.log("Video source: ", trial.stimulus[0]);
    
      if (video_preload_blob) {
        video_element.src = video_preload_blob;
      } else {
        console.log("Using direct source:", trial.stimulus[0]);
        video_element.src = trial.stimulus[0]; // Ensure this is correctly set
      }
      
      // Event listener for error handling
      video_element.onerror = () => {
        console.error("Error loading video:", video_element.error);
      };
